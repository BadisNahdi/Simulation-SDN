...
def visualize_network(net):
    ...
    with dot.subgraph(name='cluster_0') as site_a:
        ...
        site_a.node('s1', 'S1', fillcolor='lightgrey')
    ...
    with dot.subgraph(name='cluster_1') as site_b:
        ...
        site_b.node('s4', 'S4', fillcolor='lightgrey')
    
    # Add central switches
    dot.node('s2', 'S2 (connecting slice)', fillcolor='lightgrey')
    dot.node('s3', 'S3 (connecting slice)', fillcolor='lightgrey')
